...
isa_ok ( $hps_fast_track_bacteria_mapping->analysis_runners()->[0], 'Bio::HPS::FastTrack::PipelineRun::MappingAnalysis', 'PipelineRun module hook' );
...
isa_ok ( $hps_fast_track_bacteria_assembly_annotation->analysis_runners()->[0], 'Bio::HPS::FastTrack::PipelineRun::AssemblyAndAnnotationAnalysis', 'PipelineRun module hook' );
...
isa_ok ( $hps_fast_track_bacteria_snp_calling->analysis_runners()->[0], 'Bio::HPS::FastTrack::PipelineRun::SNPCallingAnalysis', 'PipelineRun module hook' );
...
isa_ok ( $hps_fast_track_bacteria_rna_seq->analysis_runners()->[0], 'Bio::HPS::FastTrack::PipelineRun::RNASeqAnalysis', 'PipelineRun module hook' );
...
isa_ok ( $hps_fast_track_bacteria_pan_genome->analysis_runners()->[0], 'Bio::HPS::FastTrack::PipelineRun::PanGenomeAnalysis', 'PipelineRun module hook' );
...
isa_ok ( $hps_fast_track_bacteria_tradis->analysis_runners()->[0], 'Bio::HPS::FastTrack::PipelineRun::TradisAnalysis', 'PipelineRun module hook' );
...
isa_ok ( $hps_fast_track_bacteria_mapping_assembly_annotation->analysis_runners()->[0], 'Bio::HPS::FastTrack::PipelineRun::MappingAnalysis', 'PipelineRun module hook' );
isa_ok ( $hps_fast_track_bacteria_mapping_assembly_annotation->analysis_runners()->[1], 'Bio::HPS::FastTrack::PipelineRun::AssemblyAndAnnotationAnalysis', 'PipelineRun module hook' );
...
isa_ok ( $hps_fast_track_bacteria_all->analysis_runners()->[0], 'Bio::HPS::FastTrack::PipelineRun::MappingAnalysis', 'PipelineRun module hook' );
isa_ok ( $hps_fast_track_bacteria_all->analysis_runners()->[1], 'Bio::HPS::FastTrack::PipelineRun::AssemblyAndAnnotationAnalysis', 'PipelineRun module hook' );
isa_ok ( $hps_fast_track_bacteria_all->analysis_runners()->[2], 'Bio::HPS::FastTrack::PipelineRun::SNPCallingAnalysis', 'PipelineRun module hook' );
isa_ok ( $hps_fast_track_bacteria_all->analysis_runners()->[3], 'Bio::HPS::FastTrack::PipelineRun::RNASeqAnalysis', 'PipelineRun module hook' );
