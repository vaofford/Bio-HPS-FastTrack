...
ok( my $pan_genome_analysis_runner = Bio::HPS::FastTrack::PipelineRun::PanGenomeAnalysis->new( study =>  2027, database => 'pathogen_prok_track_test' ), 'Creating a PanGenomeAnalysis runner object');
